...
# Funcion para validar una linea del archivo que contiene la nombres.
# Devuelve un array de tamano 2. La primera posicion indica si es valido, con True y si es invalido con False.
...
def validar_linea_salarios(linea_por_validar, numero_linea):	
	...
	try:
		...
		guardar_error("El valor de salario " + str(numero_linea) + " no puede convertirse a entero! Revisar")
		array_respuesta[0] = False
		return array_respuesta
...
if (nombre_archivo_nombres.endswith(".txt") == False):
	terminar_programa("El archivo de nombres no tiene extension .txt!")
...
guardar_log("Archivos de nombres y salarios leidos OK")

# Validar que el archivo tenga el minimo numero de lineas.
# Validacion 3 (Va3)
if (numero_lineas_nombres != numero_lineas_salarios):
	terminar_programa("Los archivo de nombres y salarios deben contener el mismo numero de lineas ")
