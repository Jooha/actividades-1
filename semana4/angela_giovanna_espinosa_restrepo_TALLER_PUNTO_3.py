...
def imprimir_array_liquidacion(array_de_liquidacion):
	print (array_de_liquidacion)
	
def imprimir_archivo_liquidacion(nombre_liquidacion):
	print (leer_lineas_archivo(nombre_liquidacion))
